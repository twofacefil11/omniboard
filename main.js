...
function createBoard() {
    ...
    for (let i = 0; i < r; i++) {
        ...
        for (let j = 0; j < c; j++) {
            ...
            if (i == 0) {
                if (j == 0)
                    square.style.borderRadius = br + 'dv 0dv 0dv 0dv';
                else if (j == c - 1)
                    square.style.borderRadius = '0dv ' + br + 'dv 0dv 0dv';
            }
            else if (i == r - 1) {
                if (j == c - 1)
                    square.style.borderRadius = '0dv 0dv ' + br + 'dv 0dv';
                else if (j == 0)
                    square.style.borderRadius = '0dv 0dv 0dv ' + br + 'dv';
            }
            board.append(square);
        }
    }
