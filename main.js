...
function createBoard() {
    ...
    for (let i = 0; i < r; i++) {
        ...
        for (let j = 0; j < c; j++) {
            ...
            let br - boardRadiusSldr.value;
            //board radius to corners //było 23 w px
            let br = (parseInt(boardRadiusSldr.value) - boardRadiusSldr.value).toString();
            if (i == 0) {
                if (j == 0)
                    square.style.borderRadius = br + '% 0% 0% 0%';
                else if (j == c - 1)
                    square.style.borderRadius = '0% ' + br + '% 0% 0%';
            }
            else if (i == r - 1) {
                if (j == c - 1)
                    square.style.borderRadius = '0% 0% ' + br + '% 0%';
                else if (j == 0)
                    square.style.borderRadius = '0% 0% 0% ' + br + '%';
            }
            board.append(square);
        }
    }
